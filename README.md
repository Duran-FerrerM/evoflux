...
## Dataset
![](images/dataset.png)<br>
Chronic lymphocytic leukemia patient samples were collected from across Europe. All 995 cases were divided into a discovery (n=631) and validation (n=374) cohorts.
